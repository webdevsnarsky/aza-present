                ...
                <div class="header__menus-item header__cat-wrap header__cat-wrap_desct-hidden">
                  <!-- <nav class="header__cat-nav">
                    <ul class="header__cat-menu">
                      ...
                      <li class="menu-item"><a href="">Шкатулки</a></li>
                      <li class="menu-item"><a href="">Шляпные коробки</a></li>
                      <li class="menu-item"><a href="">Корзины</a></li>
                      <li class="menu-item"><a href="">Цветы</a></li>
                      <li class="menu-item"><a href="">Воздушные шары</a></li>
